            ...
            <nav style="padding:0.5rem 0.75rem; display:flex; flex-direction:column; gap:4px;">
                ...
                <a href="#"
                   style="display:flex; align-items:center; gap:12px; padding:0.65rem 0.85rem;
                          border-radius:0.75rem; font-size:0.9rem; font-weight:500; color:#6B7280;"
                   onmouseover="this.style.background='#F3F4F6'" onmouseout="this.style.background='transparent'">
                    <i data-lucide="file-question" style="width:18px;height:18px;flex-shrink:0;"></i> Quiz
                </a>
                <a href="#"
                   style="display:flex; align-items:center; gap:12px; padding:0.65rem 0.85rem;
                          border-radius:0.75rem; font-size:0.9rem; font-weight:500; color:#6B7280;"
                   onmouseover="this.style.background='#F3F4F6'" onmouseout="this.style.background='transparent'">
                    <i data-lucide="play-square" style="width:18px;height:18px;flex-shrink:0;"></i> Simulasi
                </a>
                <a href="#"
                   style="display:flex; align-items:center; gap:12px; padding:0.65rem 0.85rem;
                          border-radius:0.75rem; font-size:0.9rem; font-weight:500; color:#6B7280;"
                ...
                <a href="{{ route('profile') }}"
                   style="display:flex; align-items:center; gap:12px; padding:0.65rem 0.85rem;
                          border-radius:0.75rem; font-size:0.9rem; font-weight:500; color:#6B7280;"
                   onmouseover="this.style.background='#F3F4F6'" onmouseout="this.style.background='transparent'">
                    <i data-lucide="user-circle" style="width:18px;height:18px;flex-shrink:0;"></i> Profil
                </a>
            </nav>
        </div>
